...
contract PXBTCoin is ERC20 {
    constructor() ERC20("PAXB Token", "PXBT") {
        ...
        /**
         * @dev Transfer PXBT token to contributor contract
         */
        transfer(
        ...
        /**
         * @dev Transfer PXBT token to corporation contract
         */
        transfer(
        ...
        /**
         * @dev Transfer PXBT token to DAO contract
         */
        transfer(
        ...
        /**
         * @dev Transfer PXBT token to founder contract
         */
        transfer(
        ...
        /**
         * @dev Transfer PXBT token to NFT ecosystem contract
         */
        transfer(
